...
struct TVNormaledMesh : TVSimpleMesh< VT , IT >
{
    ...
    static void CorrectPtr( CP & r , unsigned & posEnd , const VSConstBuffer< char > & pbuff , unsigned objPos , unsigned curPos ){
        ...
        r.Modify( objPos + ((size_t)&reinterpret_cast<char const volatile&>((((TVSimpleMesh<VT,IT>*)0)->pNormals)))
...
{  
    ...
    template< typename TP > static void MapTo( TP & mapper , const VSPerfectMesh & ti ){
