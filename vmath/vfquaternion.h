 ...
 * 
 * Notes:  
 * if |q|=1 then q is a unit VFQuaternion
 * if q=(0,v) then q is a pure VFQuaternion 
...
public :
	...
	//! gets the length of this VFQuaternion
	float length() const
    { return sqrt( s*s + v.SqrMagnitude() ); }

	//! gets the squared length of this VFQuaternion
	...
	//operator VDMATRIX4() const
	//{		
 //       VDMATRIX4 mat ; 
 //       return VDMATRIX4( s,  -v.x, -v.y,-v.z,
	//			          v.x,  s,  -v.z, v.y,
	//			          v.y, v.z,    s,-v.x,
	//			          v.z,-v.y,  v.x,   s );
	//}
 ...
 //   	//! rotates v by this VFQuaternion (VFQuaternion must be unit)
	//VFVector3 rotate(const VFVector3 &v)
	//{   
 //       return (*this)*v ;
	//	VFQuaternion V(0, v);
	//	VFQuaternion conjugate(*this);
 ...
 //       return vt.v;
    ...
    // rotates v by this VFQuaternion
