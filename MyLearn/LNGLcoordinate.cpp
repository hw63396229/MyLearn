...
//	Shader  myShader("6.3.coordinate_systems.vert", "6.3.coordinate_systems.frag");
//
...
//	//set the texture filterint parameters
...
//		myShader.setMat4("projection", projection);// note: currently we set the projection matrix each frame, but since the projection matrix rarely changes 
