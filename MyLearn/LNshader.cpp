...
//	glGenBuffers(1, &VBO);
//
//	//bind the vertex array object first, then bind and set vertex buffer(s), and then configure vertex atrributes
...
//
//		//glfw: swap the buffers and poll IO events(keys pressed/released, mouse moved etc)
