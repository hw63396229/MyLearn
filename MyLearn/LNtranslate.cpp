...
//	Shader  myShader("5.1.transform.vs", "5.1.transform.fs");
//
...
//		myShader.use();
//		unsigned transformLoc = glGetUniformLocation(myShader.ID, "transform");
...
//void processInput(GLFWwindow* window)
//{
//	if (glfwWindowShouldClose(window) == GLFW_KEY_ESCAPE)
//	{
