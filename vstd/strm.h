...
private:
    ...
    static void vf_build_persist( T & obj , std::ifstream & ss , void ( T::*func )( TOutput & outval , const TARGs & ... ) , F f )
    {
        TOutput outval ;
...
public : 
    ...
    {
        vf_build_persist( m_obj , ss , &T::Build , []( const auto & val ){} ) ;
    }
    ...
    {
        vf_build_persist( m_obj , ss , &T::Build , f ) ;
    }
    template< typename F >
